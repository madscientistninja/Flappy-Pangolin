...
function create() {
    ...
    // Add fence
    fence = game.add.tileSprite(5, game.world.height - 116.5, game.world.width, 155, 'fence');
    fence.tileScale.setTo(0.6, 0.6);
    // Add score text
...
function update() {
    ...
    // Scroll fence
    if (!gameOver) {
        fence.tilePosition.x -= game.time.physicsElapsed * SPEED / 1;
    }
    // Decrease cobra mode
